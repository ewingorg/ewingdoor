  ...
  public void request() {
    try {
      ExpressApiService expressApiService =
          (ExpressApiService) SpringCtx.getByBeanName("expressApiService");

      ExpressApiRespDto dto = expressApiService.request("yuantong", "881142919526377939");
