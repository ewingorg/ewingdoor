...
CREATE TABLE `web_resource_price` (
  ...
  `cost` varchar(20) DEFAULT '0' COMMENT '产品成本价',
  `price` varchar(20) DEFAULT '0' COMMENT '产品价格',
  ...
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='资源价格';

/*Data for the table `web_resource_price` */

insert  into `web_resource_price`(`id`,`resource_id`,`spec_ids`,`cost`,`price`,`gift_score`,`stock_num`,`rank`,`iseff`,`create_time`,`last_update`) values (14,7,'16,19','1000','900',NULL,10,4,'1','2016-01-15 15:26:48','2016-01-15 15:26:48'),(15,7,'16,20','1000','900',NULL,10,3,'1','2016-01-15 15:26:48','2016-01-15 15:26:48'),(16,7,'17,19','1000','900',NULL,10,2,'1','2016-01-15 15:26:51','2016-01-15 15:26:51'),(17,7,'17,20','1000','900',NULL,10,1,'1','2016-01-15 15:26:51','2016-01-15 15:26:51');
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='资源规格';

/*Data for the table `web_resource_spec` */

insert  into `web_resource_spec`(`id`,`resource_id`,`spec`,`root_spec`,`rank`,`iseff`,`create_time`,`last_update`) values (15,7,'机身颜色',NULL,1,'1','2016-01-14 13:45:53','2016-01-14 13:45:53'),(16,7,'蓝色','机身颜色',1,'1','2016-01-14 13:45:53','2016-01-14 13:45:53'),(17,7,'绿色','机身颜色',2,'1','2016-01-14 13:45:53','2016-01-14 13:45:53'),(18,7,'内存',NULL,2,'1','2016-01-14 13:45:53','2016-01-14 13:45:53'),(19,7,'16G','内存',1,'1','2016-01-14 13:45:53','2016-01-14 13:45:53'),(20,7,'32G','内存',2,'1','2016-01-14 13:45:53','2016-01-14 13:45:53');
