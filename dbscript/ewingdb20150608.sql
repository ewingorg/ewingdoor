...
CREATE TABLE `web_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='分类配置';

/*Data for the table `web_category` */

LOCK TABLES `web_category` WRITE;

insert  into `web_category`(`id`,`parent_id`,`group_type`,`group_key`,`name`,`image_url`,`link_url`,`rank`,`iseff`,`create_time`,`last_update`,`tempalte`,`short_desc`) values (24,0,'0','WEBSITE_LOGO','网站logo图标','/fileupload/logo1433687744489.jpg','#',1,'1','2015-06-07 22:36:00','2015-06-07 22:36:00',NULL,NULL),(25,0,'0','SITE_NAV','简介',NULL,'#Home',1,'1','2015-06-07 22:52:12','2015-06-07 23:00:32',NULL,NULL),(26,0,'0','SITE_NAV','案例',NULL,'#Portfolio',2,'1','2015-06-07 22:52:41','2015-06-07 23:01:01',NULL,NULL),(27,0,'0','SITE_NAV','明星代言',NULL,'#services',3,'1','2015-06-07 22:53:00','2015-06-07 23:50:21',NULL,NULL),(28,0,'0','SITE_NAV','热门货品',NULL,'#about',4,'1','2015-06-07 22:53:14','2015-06-07 23:50:37',NULL,NULL),(29,0,'0','SITE_NAV','加盟须知',NULL,'#Join',5,'0','2015-06-07 22:53:30','2015-06-07 23:48:59',NULL,NULL),(30,0,'0','SITE_NAV','关于我们',NULL,'#contact',6,'1','2015-06-07 22:53:44','2015-06-07 23:50:49',NULL,NULL),(31,0,'1','INDEX_INTRO','简介页面','/fileupload/home1433692651710.jpg',NULL,1,'1','2015-06-07 23:57:47','2015-06-08 00:07:53',NULL,NULL),(32,0,'1','INDEX_CASE','首页案例图','/fileupload/case1433693350537.jpg',NULL,1,'1','2015-06-08 00:09:18','2015-06-08 00:14:31',NULL,NULL),(33,0,'1','INDEX_STAR','首页明星代言图','/fileupload/start1433694059588.jpg',NULL,1,'1','2015-06-08 00:21:07','2015-06-08 00:21:07',NULL,NULL),(34,0,'1','INDEX_ABOUT','首页关于我们','/fileupload/aboutme1433694278087.jpg',NULL,1,'1','2015-06-08 00:24:45','2015-06-08 00:24:45',NULL,NULL);
...
CREATE TABLE `web_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='组配置';
...
insert  into `web_template`(`id`,`name`,`template_path`,`group_keys`,`iseff`,`create_time`,`last_update`,`template_type`) values (4,'首页','/d1box/index.html','WEBSITE_LOGO,SITE_NAV,INDEX_INTRO,INDEX_CASE,INDEX_STAR','1','2015-03-02 21:44:54','2015-06-08 00:21:29','0');
