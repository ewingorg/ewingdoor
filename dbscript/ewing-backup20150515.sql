...
CREATE TABLE `web_attr_conf` (
  ...
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='模板资源的属性';
...
insert  into `web_template`(`id`,`name`,`template_path`,`group_keys`,`iseff`,`create_time`,`last_update`,`template_type`) values (2,'首页','/vgooo/index.html','SITE_NAV,HELP_NAV,HOT_PHONE_LIST','1','2015-03-02 21:44:54','2015-03-02 22:30:28',''),(3,'手机详细页','/vgooo/phonedetail.html',NULL,'1','2015-03-02 21:44:54','2015-05-15 14:19:07','');
