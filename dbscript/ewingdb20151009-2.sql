...
/*Data for the table `category_conf` */

LOCK TABLES `category_conf` WRITE;
...
/*Data for the table `resource_attr` */

LOCK TABLES `resource_attr` WRITE;

insert  into `resource_attr`(`id`,`attr_key`,`attr_name`,`attr_value`,`rank`,`resource_id`,`iseff`,`create_time`,`last_update`) values (1,'price','价钱','1000',0,1,'1','2015-05-20 17:51:37','2015-05-20 17:51:40'),(2,'price','价格','19999',0,3,'1','2015-05-21 18:04:03','2015-05-21 18:04:03'),(3,'screen_size','屏膜大小','14寸',1,3,'1','2015-05-21 18:04:07','2015-05-21 18:04:07');

UNLOCK TABLES;

/*Table structure for table `resource_param` */

DROP TABLE IF EXISTS `resource_param`;

CREATE TABLE `resource_param` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `resource_id` int(11) NOT NULL COMMENT '资源id，表resource主键',
  `param_code` varchar(50) NOT NULL COMMENT '参数编码',
  `param_name` varchar(50) NOT NULL COMMENT '参数名称',
  `param_value` varchar(50) DEFAULT NULL COMMENT '参数值',
  `root_code` varchar(50) DEFAULT NULL COMMENT '父编码',
...
/*Data for the table `resource_param` */

LOCK TABLES `resource_param` WRITE;

UNLOCK TABLES;

/*Table structure for table `resource_screenshot` */

DROP TABLE IF EXISTS `resource_screenshot`;

CREATE TABLE `resource_screenshot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `resource_id` int(11) NOT NULL COMMENT '资源id，表resource主键',
  ...
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资源截图';

/*Data for the table `resource_screenshot` */

LOCK TABLES `resource_screenshot` WRITE;

UNLOCK TABLES;

/*Table structure for table `resource_spec` */
...
/*Data for the table `resource_spec` */

LOCK TABLES `resource_spec` WRITE;
...
insert  into `web_template`(`id`,`name`,`template_path`,`group_keys`,`iseff`,`create_time`,`last_update`,`template_type`) values (3,'手机','/vgooo/phone.html',NULL,'1','2015-03-02 21:44:54','2015-06-09 22:44:24','1'),(4,'首页','/d1box/index.html','WEBSITE_LOGO,SITE_NAV,INDEX_INTRO,INDEX_CASE,INDEX_STAR,INDEX_HOTPRO,INDEX_JOIN','1','2015-03-02 21:44:54','2015-06-09 22:44:24','0');
