package com.ewing.core.wxpaysdk.api.applyrefund.constants;
 ...
 *
 */
public enum ApplyRefundErrorCode {
    ...
    ApplyRefundErrorCode(String code,String des,String cause,String deal){
        this.code = code;
        this.des = des;
        this.cause = cause;
        this.deal = deal;
