...
public class PageUtil {
     ...
     * 
     * @param limitSize 最大的限制数limitSize
     * @param page 当前页
     * @param pageSize 每页数据大小
     * @return
     */
    public static int getLimitPageSize(Integer limitSize, Integer page, Integer pageSize) {
        if (limitSize == null)
            throw new IllegalArgumentException("limitSize should not be null");
        if (page == null || page < 0)
            throw new IllegalArgumentException("page should not be null or illegal value");
